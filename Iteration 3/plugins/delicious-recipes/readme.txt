...
The plugin also includes __User Dashboard__ feature which allow your readers to sign up to your website, browse your recipes and add the recipes to their favorite list.
...
== Key Features ==
* **_User Dashboard_** - Allows your readers to browse and add recipes to their fovorite list.
...
* **_9 Gutenberg Blocks_** - Beautiful and handy recipe blocks to create and add recipe cards to the new Gutenberg editor.
